...
/***/ function(module, exports, __webpack_require__) {
	...
	function setUpOrDown() {
		var upOrDown = arguments.length <= 0 || arguments[0] === undefined ? 'UP' : arguments[0];

		if (upOrDown === 'UP') {
			(0, _jquery2.default)('.up').addClass('show');
			(0, _jquery2.default)('.down').removeClass('show');
		} else {
			(0, _jquery2.default)('.down').addClass('show');
			(0, _jquery2.default)('.up').removeClass('show');
		}
	}
